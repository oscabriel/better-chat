...
function SessionItem({
	...
	const deviceInfo = useQuery({
		...trpc.user.getDeviceInfo.queryOptions({
...
export function SessionManager() {
	...
	const sessions = useQuery({
		...trpc.user.listSessions.queryOptions(),
	...
	const handleSessionTerminate = async (session: Session) => {
		// Use a unique identifier for the terminating session
		...
		if (isCurrentSession) {
			// For current session, use authClient signOut
			...
			// For other sessions, use tRPC mutation
